...
import { CreateAssignmentForm } from "@/components/office/assignments/CreateAssignmentForm";
...
export const metadata: Metadata = {
  title: "Create Assignment — Office Portal",
...
export default async function CreateAssignmentPage() {
  ...
  if (!user) {
    redirect("/login?callbackUrl=/office/assignments/new");
  }
      ...
      <div className="max-w-3xl">
        <header className="mb-6">
          ...
          <p className="text-sm text-slate-500">
            Create a new assignment for your course. Set the deadline, maximum marks, and publish when ready.
          </p>
        </header>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Fill in the assignment details below. You can save as draft and publish later.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <CreateAssignmentForm courseOptions={courseOptions} />
          </CardContent>
        </Card>
      </div>
    </OfficeShell>
