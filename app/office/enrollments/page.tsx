...
function Summary({ icon: Icon, label, value }: { icon: typeof ContactRound; label: string; value: number }) { return <Card><CardContent className="flex items-center gap-3 p-4 sm:pt-4"><span className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary-50 text-primary-700"><Icon className="h-5 w-5" /></span><div><p className="text-xl font-bold text-slate-900">{value}</p><p className="text-xs text-slate-500">{label}</p></div></CardContent></Card>; }
