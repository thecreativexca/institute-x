...
import { AnnouncementDetail } from "@/components/office/announcements/AnnouncementDetail";
...
export const metadata: Metadata = {
  title: "Announcement Details — Office Portal",
...
export default async function AnnouncementDetailPage({ params }: AnnouncementDetailPageProps) {
  ...
  if (!user) {
    redirect(`/login?callbackUrl=/office/announcements/${announcementId}`);
  }
